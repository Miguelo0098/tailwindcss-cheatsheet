...
export class TestView {
  constructor(context: vscode.ExtensionContext) {
    const view = vscode.window.createTreeView("twcss-layout", {
      treeDataProvider: aNodeWithIdTreeDataProvider(),
      showCollapseAll: true,
    });
    context.subscriptions.push(view);
    vscode.commands.registerCommand("twcss-layout.reveal", async () => {
    ...
    vscode.commands.registerCommand("twcss-layout.changeTitle", async () => {
